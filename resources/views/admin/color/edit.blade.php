                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('color.list')}}">List Size</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form action="{{route('color.update', $color->id)}}" method="post" name="categoryForm">
                                @csrf
                                @method('POST')
                                <div class="form-group required">
                                    <label for="inputName">Color Name</label>
                                    <input type="text" id="input-name" name="name" value="{{$color->name}}" class="form-control">
