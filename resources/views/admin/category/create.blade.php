            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form action="{{route('category.store')}}" method="post" id="form-data" name="categoryForm">
                                @csrf
                                @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="input-description" name="description" class="form-control" rows="4"></textarea>
