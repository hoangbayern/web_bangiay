        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    ...
                    <li class="breadcrumb-item"><a class="white-text" href="{{route('client.myOrders')}}">My Orders</a></li>
                                    ...
                                    <li class="list-group-item">
                                        <div class="row align-items-center">
                                            <div class="col-4 col-md-3 col-xl-2">
                                                ...
                                                <!-- Image -->
                                                <a href="{{route('client.product', $item->name)}}">
                                                    @if(!empty($productImage->image))
                                                        <img class="img-fluid" src="{{asset('uploads/products/small/'.$productImage->image)}}" alt="imgProduct">
                                                    @else
                                                        <img class="img-fluid" src="/uploads/temp/default_product.png" alt="imgProduct">
                                                    @endif
                                                </a>
                                            </div>
                                            <div class="col">
                                                ...
                                                <p class="mb-4 fs-sm fw-bold">
                                                    <a class="text-body" href="{{route('client.product', $item->name)}}">{{$item->name}} - {{$item->size}}, {{$item->color}}  <span class="text-success">x {{$item->qty}}</span></a> <br>
