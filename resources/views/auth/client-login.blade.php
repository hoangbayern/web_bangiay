    ...
    <section class=" section-10">
        <div class="container">
            <div class="login-form">
                <form action="{{route('client.postLoginClient')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                ...
                @enderror
                <div class="text-center small pt-3">Don't have an account? <a href="{{route('client.register')}}">Sign up</a></div>
            </div>
        </div>
    </section>
@endsection
